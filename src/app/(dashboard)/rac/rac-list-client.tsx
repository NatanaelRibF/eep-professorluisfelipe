...
import { Search, Loader2, Calendar, User, FileText, AlertCircle } from "lucide-react";
...
export default function RacListClient({ classes, racTypes }: { classes: any[], racTypes: any[] }) {
  ...
  return (
    <div className="space-y-4">
      {/* Filters Card */}
      <div className="bg-white p-3.5 sm:p-4 rounded-xl shadow-sm border grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 items-end">
        <div>
