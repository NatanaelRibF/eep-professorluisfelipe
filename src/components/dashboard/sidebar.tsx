      ...
      >
        ...
        <div className="border-t border-slate-800 p-2 space-y-1">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-md px-3 py-2 text-xs font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition-colors cursor-pointer"
          >
